...
class MainActivity : AppCompatActivity() {
    ...
    private fun sendOfferApiOrtb() {
        ...
        val url = String.format("http://offers.propellerads.com/api/v1/ads_open_rtb/6148963/?auth=%s", auth)
//            local debug
//            "http://192.168.64.1:80/api/v1/ads_open_rtb/6105005/?auth=07ab798bed6bf5f0eefef36ff2102db57a53dfd4"
        ...
        Log.i(MainActivity::class.toString(), String.format("url: %s\nrequest body: %s", url, requestBody))
        ...
        val jsonObjectRequest = object : JsonObjectRequest(
            ...
            { response ->
                ...
                val unencodedAdm = response.getJSONArray("seatbid").getJSONObject(0).getJSONArray("bid")
                    .getJSONObject(0).getString("adm");
                val encodedHtml =
                    Base64.encodeToString(unencodedAdm.toByteArray(), Base64.NO_PADDING)

//                myWebView.loadUrl("https://www.offers.propellerads.com");
//                myWebView.loadUrl("https://www.offers.propellerads.com");
//                Thread.sleep(50000)
